...
if [ ! -f ${DATA_DIRECTORY}/wmt16.cache ]; then
    ...
    OUTPUT_DIR=${DATA_DIRECTORY}/wmt16
    OUTPUT_DIR_DATA="${OUTPUT_DIR}/data"

    mkdir -p $OUTPUT_DIR_DATA

    echo "Downloading Europarl v7. This may take a while..."
    wget -nc -nv http://www.statmt.org/europarl/v7/de-en.tgz -O ${OUTPUT_DIR_DATA}/europarl-v7-de-en.tgz
    ...
    # Filter datasets
    python ${SCRIPT_PATH}/filter_dataset.py -f1 ${OUTPUT_DIR}/train.tok.clean.en -f2 ${OUTPUT_DIR}/train.tok.clean.de
    python ${SCRIPT_PATH}/filter_dataset.py -f1 ${OUTPUT_DIR}/newstest_dev.tok.clean.en -f2 ${OUTPUT_DIR}/newstest_dev.tok.clean.de

    # /Tmp/delaunap//data/wmt16/subword-nmt/learn_bpe.py:267
    # /Tmp/delaunap/data/wmt16/subword-nmt/subword_nmt
    ...
    touch ${DATA_DIRECTORY}/wmt16.cache
    echo "All done."
else
    echo 'DONE'
fi
